# Skill Registry — landing-eventos
...
- C:\Users\damia\.pi\agent\skills
- C:\Users\damia\.agents\skills
- C:\Users\damia\.config\opencode\skills
- C:\Users\damia\.gemini\skills
- C:\Users\damia\.copilot\skills
- C:\Users\damia\.codex\skills
- C:\Users\damia\.kiro\skills
- C:\Users\damia\.openclaw\skills
...
### branch-pr
- Path: C:\Users\damia\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\damia\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\damia\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\damia\.config\opencode\skills\comment-writer\SKILL.md
...
### content-strategy
- Path: C:\Users\damia\.agents\skills\content-strategy\SKILL.md
- Rules:
...
### find-skills
- Path: C:\Users\damia\.agents\skills\find-skills\SKILL.md
...
### go-testing
- Path: C:\Users\damia\.config\opencode\skills\go-testing\SKILL.md
...
### imagegen
- Path: C:\Users\damia\.codex\skills\.system\imagegen\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: C:\Users\damia\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\damia\.config\opencode\skills\judgment-day\SKILL.md
...
### openai-docs
- Path: C:\Users\damia\.codex\skills\.system\openai-docs\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: C:\Users\damia\.codex\skills\.system\plugin-creator\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### schema
- Path: C:\Users\damia\.agents\skills\schema\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### seo-audit
- Path: C:\Users\damia\.agents\skills\seo-audit\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\damia\.config\opencode\skills\skill-creator\SKILL.md
...
### skill-installer
- Path: C:\Users\damia\.codex\skills\.system\skill-installer\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\damia\.config\opencode\skills\work-unit-commits\SKILL.md
